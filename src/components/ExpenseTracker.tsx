...
const ExpenseTracker = () => {
  const [expenses, setExpenses] = useState([
    { id: 1, title: "Grocery Shopping", amount: 850, category: "Food", date: "2024-01-15", description: "Weekly groceries from supermarket" },
    { id: 2, title: "Coffee & Breakfast", amount: 120, category: "Food", date: "2024-01-15", description: "Morning coffee and sandwich" },
    { id: 3, title: "Bus Fare", amount: 50, category: "Transport", date: "2024-01-14", description: "Daily commute" },
    { id: 4, title: "Movie Tickets", amount: 400, category: "Entertainment", date: "2024-01-13", description: "Weekend movie with friends" },
    { id: 5, title: "New T-shirt", amount: 699, category: "Shopping", date: "2024-01-12", description: "Casual wear from online store" }
  ]);
          ...
          <Card className="mb-8 border-green-200 bg-green-50/50">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Input type="date" />
                <Input placeholder="Description (optional)" className="md:col-span-2" />
              </div>
